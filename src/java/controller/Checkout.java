...
public class Checkout extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String districtId = requestJsonObject.get("districtId").getAsString();
        ...
        if (httpSession.getAttribute("user") != null) {
            ...
            if (isCurrentAddress) {
                ...
                if (firstName.isEmpty()) {
                    ...
                    criteria4.add(Restrictions.eq("id", Integer.parseInt(districtId)));
                    ...
                    if (criteria3.list().isEmpty()) {
                        ...
                        if (criteria4.list().isEmpty()) {
                            responseJsonObject.addProperty("message", "Invalid District selected");
                        } else {
                            //city found
    ...
    private void saveOrders(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            ...
            String merchant_id = "1225747";
            String formatted_amount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchantSecret = "MjEwNDkzMTQ0MjE0MTgwMzYxNjEyODc3NzE0OTUwMTAyMTkyNjI5Ng=="; //**
