async function loadProduct() {
    ...
    if (parameters.has("pid")) {
        ...
        if (response.ok) {
            ...
            document.getElementById("image1").src = "product_images/" + pid + "/image1.png";
...
//            document.getElementById("product-published-on").innerHTML = json.product.date_time;
            ...
            document.getElementById("product-category").innerHTML = json.product.product_category.name;
            ...
            json.productList.forEach(item => {
                ...
                productCloneHtml.querySelector("#similar-product-a1").href = "single-product-view.html?pid=" + item.id;
