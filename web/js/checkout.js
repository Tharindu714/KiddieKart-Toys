        ...
        if (json.success) {
            ...
            cartList.forEach(item => {
                ...
                st_item_clone.querySelector("#st-item-title").innerHTML = item.product.title;
                                st_item_clone.querySelector("#st-item-img").src = "product_images/" + item.product.id + "/image1.png";
                st_item_clone.querySelector("#st-item-qty").innerHTML = item.qty;
                st_item_clone.querySelector("#st-item-price").innerHTML = new Intl.NumberFormat(
                        "en-US",
                        {
